    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-slate-900 border border-red-700 rounded-xl p-6 shadow-md">
            ...
            <form action="{{ route('admin.questions.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Laravel, SQL, Networking..."
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="w-full rounded-lg bg-slate-800 border border-slate-700 text-slate-200 px-3 py-2 focus:border-red-500 focus:ring-red-500"
                        >
                            <option value="easy" @selected(old('difficulty','easy') === 'easy')>Easy</option>
                ...
                <!-- Options (A-D required, E optional per controller validation) -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                ...
                <div>
                    ...
                    >
                        @foreach(['a','b','c','d','e'] as $opt)
                            <option value="{{ $opt }}" @selected(old('correct_option','a') === $opt)>
                                {{ strtoupper($opt) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-2">
                            Max 2MB. Stored in <code class="text-slate-300">storage/app/public/questions</code>.
                        </p>
                    </div>
                </div>
